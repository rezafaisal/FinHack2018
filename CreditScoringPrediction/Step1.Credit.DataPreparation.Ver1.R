...
main_data.train = read.csv("data/npl_train.csv", stringsAsFactors = TRUE)
main_data.train = main_data.train[,c(-1)]

#convert data menjadi kategori
...
model = randomForest(flag_kredit_macet ~ ., data=main_data.train, importance=TRUE, proximity=TRUE)
